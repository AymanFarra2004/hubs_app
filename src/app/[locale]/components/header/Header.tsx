      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex md:hidden items-center space-x-1 rtl:space-x-reverse">
            ...
            <button
              onClick={handleLocaleSwitch}
              className="cursor-pointer p-2 rounded-full bg-foreground/5 text-foreground hover:bg-foreground/10 transition-colors text-xs font-bold flex items-center gap-1 px-2.5"
            >
