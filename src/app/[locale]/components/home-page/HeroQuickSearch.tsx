  ...
  return (
    <div className="bg-background rounded-full shadow-lg border border-border p-2 flex flex-col sm:flex-row gap-2 max-w-2xl mx-auto">
                <div className="flex-1 relative">
                  ...
                  <select className="w-full h-12 pl-12 pr-4 bg-transparent appearance-none focus:outline-none text-foreground cursor-pointer rounded-full hover:bg-muted/50 transition-colors">
                    <option value="">{t("filters.governorates.placeholder")}</option>
                    <option value="North Gaza">{t("filters.governorates.northGaza")}</option>
                    <option value="Gaza City">{t("filters.governorates.gazaCity")}</option>
