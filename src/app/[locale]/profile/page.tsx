        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {result.error || !result.data ? (
            <div className="flex flex-col items-center justify-center py-24 px-6 text-center rounded-3xl bg-background border border-border/60 shadow-sm animate-in fade-in duration-500">
              ...
              <Link
                href="/sign-in"
                className="cursor-pointer inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary text-primary-foreground font-semibold hover:opacity-90 shadow-lg shadow-primary/25 transition-all hover:scale-105 active:scale-95"
              >
